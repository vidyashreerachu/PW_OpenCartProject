...
export class RegistrationPage 
{
    ...
    constructor(page:Page)
    {
        ...
        this.btnContinue = page.locator('[value="Continue"]');
    ...
    async getConfirmationMsg(): Promise<string> {
        // “Return the result of textContent() unless it is null or undefined; otherwise return an empty string ''.”
                                        ...
                                        pwd: string }): Promise<void>
    {
        ...
        await this.setPassword(userData.pwd);
        await this.setConfirmPassword(userData.pwd);
